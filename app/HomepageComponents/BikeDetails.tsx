...
const BikeDetails = () => {
  return (
   ...
   <div className='w-full flex items-center justify-center md:max-w-[500px] '>
      ...
      <Link href="/bike"  style={{fontWeight:400}} className={`${jost.className} hover:cursor-pointer text-white   w-1/2 flex items-center justify-center bg-green-500  text-xl py-3  rounded-md`}>Explore Bikes</Link>
   </div>
   </div>
