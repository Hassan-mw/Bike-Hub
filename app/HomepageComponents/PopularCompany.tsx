            ...
            <div className="group relative m-auto max-w-7xl px-6 pb-9 border-b ">
                <div className="flex flex-col items-center space-y-5 ">
                    <div className="w-full flex flex-col items-center justify-center">
                        ...
                        <div style={{fontWeight:400}} className={`${jost.className}  text-md text-[#879099]  `}>Lorem ipsum  sit amet elit, sed do eiusmod tempor </div> 
                    </div>
                    <div className="relative py-6 md:w-[calc(100%-11rem)]">
                        <InfiniteSlider
                            ...
                            gap={112}>
                            <div className="flex">
                            <img className='h-12' src='./c-h.png'/>
                            </div>

                            <div className="flex">
                            <img className='h-12  ' src='./c-s.png'/>
                            </div>
                            <div className="flex">
                           <img className='h-12  ' src="./c-bmw.png" />
                            </div>
                            <div className="flex">
                            <img className='h-12  ' src="./c-d.png" />

                            </div>
                            <div className="flex">
                            <img className='h-12  ' src="./c-y.png" />

                            </div>
                            <div className="flex">
                            <img className='h-12 ' src="./c-hd.png" />
