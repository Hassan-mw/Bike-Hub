...
const data=[
  ...
  {image:"/user-1742578949550.jpeg",name:"yamaha 150",price:"333",review:"34",url:"triumph-tiger-900"},
...
<Carousel>
  ...
  {
    data.map((data,index)=>
    <CarouselItem key={data.name}  className="sm:basis-1/2  md:basis-1/3  h-1/2  rounded-lg bg-white ">
